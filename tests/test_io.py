...
from object_annotator.libs.create_ml_io import CreateMLReader, CreateMLWriter
from object_annotator.libs.pascal_voc_io import PascalVocReader, PascalVocWriter
...
class TestCreateMLRW(unittest.TestCase):
    ...
    def test_a_write(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            shapes = [person, face]
            output_file = os.path.join(tmp, "tests.json")
